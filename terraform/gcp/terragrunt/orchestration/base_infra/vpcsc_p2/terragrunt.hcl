...
protected_project_ids = local.env_config.vpcsc.service_perimeters.perimeter2.protected_project_ids
protect_xvpc = local.env_config.vpcsc.service_perimeters.perimeter2.protect_xvpc
members = local.env_config.vpcsc.allowed_identities
restricted_services = local.env_config.vpcsc.service_perimeters.perimeter2.restricted_services
perimeter_name  = local.env_config.vpcsc.service_perimeters.perimeter2.perimeter_name
access_level_name  = dependency.vpcscpolicy.outputs.access_level_name
allowed_egress_projects = local.env_config.vpcsc.service_perimeters.perimeter2.allowed_egress_projects
}
